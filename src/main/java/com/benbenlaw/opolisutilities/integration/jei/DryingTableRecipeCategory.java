...
public class DryingTableRecipeCategory implements IRecipeCategory<DryingTableRecipe>{
        ...
        public final static ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(OpolisUtilities.MOD_ID, "drying_table");
    ...
    @Override
    public @Nullable ResourceLocation getRegistryName(DryingTableRecipe recipe) {
        assert Minecraft.getInstance().level != null;
        return Minecraft.getInstance().level.getRecipeManager().getAllRecipesFor(DryingTableRecipe.Type.INSTANCE).stream()
