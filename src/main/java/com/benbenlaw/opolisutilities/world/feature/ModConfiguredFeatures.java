...
public class ModConfiguredFeatures {
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES =
            DeferredRegister.create(Registry.CONFIGURED_FEATURE_REGISTRY, OpolisUtilities.MOD_ID);


    public static final Supplier<List<OreConfiguration.TargetBlockState>> OVERWORLD_ENDER_ORE = Suppliers.memoize(() -> List.of(
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> ENDER_ORE = CONFIGURED_FEATURES.register("ender_ore",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(OVERWORLD_ENDER_ORE.get(),8)));
    /*
