...
public class ClientListener {
    ...
    public static void registerOverlay(RegisterGuiOverlaysEvent event) {
        event.registerAbove(VanillaGuiOverlay.CROSSHAIR.id(), "scrambler_range", (gui, guiGraphics, partialTick, screenWidth, screenHeight)
                -> ModEvents.onRenderHUD(guiGraphics, partialTick));
    }
