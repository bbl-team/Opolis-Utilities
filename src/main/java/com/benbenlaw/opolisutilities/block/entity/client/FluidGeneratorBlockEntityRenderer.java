...
public class FluidGeneratorBlockEntityRenderer implements BlockEntityRenderer<FluidGeneratorBlockEntity> {
    public FluidGeneratorBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }


    @Override
    public void render(FluidGeneratorBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
                       MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {

        FluidTank fluidTank = pBlockEntity.FLUID_TANK;
        ...
        if (!fluidTank.isEmpty()) {
            ...
            renderFluid(last, buffer, pBlockEntity, fluidStack.getFluid(), fluidTank.getFluidAmount() / (float) fluidTank.getCapacity(), pPackedLight);
